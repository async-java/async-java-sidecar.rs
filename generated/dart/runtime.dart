...
SidecarEnvValues loadFrom(String? Function(String key) lookup) {
  return SidecarEnvValues(
    bind: _nonEmpty(lookup('ASYNC_JAVA_SIDECAR_BIND')) ?? '127.0.0.1:9090',
  );
}
...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final bind = pick(['ASYNC_JAVA_SIDECAR_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (bind != null) out['ASYNC_JAVA_SIDECAR_BIND'] = bind;
  return out;
}
